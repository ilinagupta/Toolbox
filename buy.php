...
<ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="buy.php" class="well">Buy Now</a></li>
        <li><a href="cod.php"  class="well">Cash On Delivery</a></li>
...
if(!isset($_SESSION['login_user'])){
  ...
  &nbsp&nbsp<a href='index.php'>Continue shopping</a>
</div>";
...
echo "<div class='col-md-4'><a href='index.php' class='btn btn-success btn-md btn-block' role='button'>Continue Shopping</a></div>";
